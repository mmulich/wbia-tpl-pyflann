"""
SeeAlso:
    flann/tests/test_add_remove.py
    flann/tests/test_index_save.py

RelevantFiles:

    # Add implementation for bindings here
    ...
    # Add Headers for C bindings here
    ...
    # Need to tell python about binding (python bindings that talk to C)
    ...
    # Core Python API that talks to python bindings
